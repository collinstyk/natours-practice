...
const handleValidationErrorDB = (err) => {
  // Extracting the messages from each error objects
...
module.exports = (err, req, res, next) => {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    // reassigning the original error to avoid messing with it
    // The new error object will not have access to the err name
    let error = {
      ...err,
      name: err.name,
      errmsg: err.errmsg,
